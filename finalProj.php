...
<div class="card mb-4">
                    <div class="card-body">
                                ...
                                <div class="card-body mx-3">
                                    <h5 class="text-primary text-center">View  Final Project List</h5>
                                    <!-- paste form -->
                                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post" action="allocation_list.php">
                                        <div class="mb-4">

...
<div class="card mb-4">
                    <div class="card-body">
                                ...
                                <div class="card-body mx-3">
                                    <h5 class="text-primary text-center">View Team List</h5>
                                    <!-- paste form -->
                                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post" action="Teamview.php">
                                        <div class="mb-4">
                                    ...
                                    placeholder="Year" data-sb-validations="required" required/>
                                        ...
                                        <div class="card-body">
                                            <button class="btn btn-primary btn-lg " id="submitbt" name="submitbt"

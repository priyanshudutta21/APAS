                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted mb-1">Department of Computer Science and Engineering</p>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">Sarat Saharia</p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">sarat@tezu.ac.in</p>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <p class="text-muted mb-0">+913712275105</p>
                                        </div>
                                    </div>
                                    <hr>
